...
setup(
    ...
    include_dirs=[
        numpy.get_include(),
        "cuda/subsampling/cpp_utils/nanoflann/nanoflann.hpp",
        "cuda/subsampling/cpp_utils/cloud/cloud.h",
        "cuda/subsampling/grid_subsampling/grid_subsampling.h",
        "cuda/pointnet2/src/cuda_utils.h",
        "cuda/pointnet2/src/group_points_gpu.h",
        "cuda/pointnet2/src/sampling_gpu.h",
        "cuda/pointnet2/src/interpolate_gpu.h",
        "cuda/pointnet2/src/ball_query_gpu.h",
        "cuda/pointops/src/sampling/sampling_cuda_kernel.h",
        "cuda/pointops/src/grouping/grouping_cuda_kernel.h",
        "cuda/pointops/src/cuda_utils.h",
        "cuda/pointops/src/knnquery/knnquery_cuda_kernel.h",
        "cuda/pointops/src/ballquery/ballquery_cuda_kernel.h",
        "cuda/pointops/src/interpolation/interpolation_cuda_kernel.h",
        "cuda/pointops/src/subtraction/subtraction_cuda_kernel.h",
        "cuda/pointops/src/aggregation/aggregation_cuda_kernel.h",
    ]
)
